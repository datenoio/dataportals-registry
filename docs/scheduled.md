...
Current queue size is in [exports.md](exports.md#record-counts) (**0** as of 26 August 2026). After a discovery pass the queue grows; after `promote_scheduled.py` it shrinks.
