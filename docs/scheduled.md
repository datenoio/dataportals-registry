...
Current queue size is in [exports.md](exports.md#record-counts) (**12** as of 24 August 2026 — UK Cadcorp SIS WebMap council viewers pending live confirmation). After a discovery pass the queue grows; after `promote_scheduled.py` it shrinks.
