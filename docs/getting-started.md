...
Working tree (8 September 2026): **35,266** verified catalog entities, **0** scheduled records, and **423** software definitions across **224** country/territory folders. Last published snapshot is v1.19.0 (29,816 catalogs, 0 scheduled, 366 software). Record-count contract: [exports.md](exports.md#record-counts).
