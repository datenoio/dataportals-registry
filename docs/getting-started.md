...
Working tree (12 September 2026): **37,170** verified catalog entities, **0** scheduled YAML records, and **486** software definitions across **224** country/territory folders. Last published snapshot is v1.21.0 (37,170 catalogs, 0 scheduled, 486 software). Record-count contract: [exports.md](exports.md#record-counts).
