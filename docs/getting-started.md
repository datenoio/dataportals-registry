...
Latest snapshot (v1.16.0, 24 August 2026): **20,142** verified catalog entities, **12** scheduled records, and **247** software definitions across **218** country/territory folders. Published JSONL, Parquet, and DuckDB exports match this count. Record-count contract: [exports.md](exports.md#record-counts).
