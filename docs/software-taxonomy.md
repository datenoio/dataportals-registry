...
| `subtype` | Use for |
|-----------|---------|
| `data_portal_platform` | Self-hosted open-data CMS (CKAN, DKAN, uData, Idra, OpenGDC, ResourceContracts, ODWeb, OpenSpending) |
| `scientific_repository_platform` | Dataverse, DSpace, Invenio, Figshare, OPUS, Omeka S, Fedora, Esploro, PHAIDRA, RADAR, Yoda, Converis, Archipelago, LabKey, DABAR, OpenScience.si, Synapse, XNAT, Shanoir, LORIS, OMERO, Kadi4Mat, e!DAL, META-SHARE, Gen3, TR32DB, DLCM, easydb |
...
| `metadata_registry_platform` | FAIR Data Point, Aristotle MDR, Fusion Registry, Metadata Browser, DataHub |
